...
absorbancia_input = st.number_input('Ingresa el valor de absorbancia:', min_value=0.1, max_value=3.0, step=0.001, value=0.275, format="%.3f")
...
ax.set_xlim([0, concentracion * 1.1])
ax.set_ylim([0, absorbancia_input * 1.1])
